...
add({ id: 'abyss_ring', kind: 'accessory', name: L('Кольцо Бездны', 'Ring of the Abyss'), icon: { shape: 'ring', c1: '#8a70ff', c2: '#2a1a4a' }, price: 3000, stack: 1, tier: 7, gender: 'n', unique: true, accessory: { slot: 'ring', stats: { dmgPct: 12, crit: 0.05, maxHp: 40, lifesteal: 0.03 } } });
